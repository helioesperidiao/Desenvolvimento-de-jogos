...
public class Personagem03x01 : MonoBehaviour {


	bool ApertouBotaoMouseEsquerdo;
	bool ApertouBotaoMouseDireita;
	bool ApertouBotaoMouseCentro;
	...
	void Update () {
		MovimentoHorizontalPlayer2 ();
		//MovimentoPuloDuploMouse ();
		//MovimentoPuloDuplo ();
		//MovimentoHorizontalFlipMouse ();
	...
	void MovimentoHorizontalFlipMouse (){
		 ApertouBotaoMouseEsquerdo = Input.GetMouseButtonDown (0);
		 ApertouBotaoMouseDireita = Input.GetMouseButtonDown (1);
		 ApertouBotaoMouseCentro = Input.GetMouseButtonDown (2);

		if (ApertouBotaoMouseEsquerdo == true) {
			print ("Apertou o botão esquerdo");
			DirecaoHorizontal = -1;
		}
		if (ApertouBotaoMouseDireita == true) {
			print ("Apertou o botão direito");
			DirecaoHorizontal = 1;
		}
		if (ApertouBotaoMouseCentro == true) {
			print ("Apertou o botão do meio");
			DirecaoHorizontal = 0;
		}
	...
	void MovimentoPuloDuploMouse(){
		...
		if (ApertouBotaoMouseEsquerdo == true && ContadorPulos < TotalPulos) {
	...
	void MovimentoHorizontalPlayer1(){
	...
	void MovimentoHorizontalPlayer2(){
