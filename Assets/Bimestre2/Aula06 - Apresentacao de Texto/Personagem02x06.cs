...
public class Personagem02x06 : MonoBehaviour
{

	public Text UITextPontos;
	public Text	UITextVidas;
	...
	void Start()
	{
		QtdVidas = 5;
		QtdPontos = 0 ;
		UITextPontos.text = "PONTOS️:  " + QtdPontos.ToString();
		UITextVidas.text = "❤️❤️❤️❤️❤️";
		TagTriggerEnter = "";
		TagTriggerStay = "";
		TagTriggerExit = "";
	...
	void OnTriggerEnter2D(Collider2D objetoTriggerEnter)
	{
		...
		if (TagTriggerEnter.Contains("pontos1"))
		{
			print("OnTriggerEnter2D():" + TagTriggerEnter);
			QtdPontos = QtdPontos + 1; // QtdPontos++;
			string textoPontos = QtdPontos.ToString();
			UITextPontos.text = "PONTOS️:  " + textoPontos;
			Destroy(objetoTriggerEnter.gameObject);
		}

		if (TagTriggerEnter.Contains("perder1Vida"))
		{
			print("OnTriggerEnter2D():" + TagTriggerEnter);
			QtdVidas = QtdVidas - 1 ; // QtdVidas++;
			...
			if (QtdVidas == 3) {
				UITextVidas.text = "❤️❤️❤️";
			}
			if (QtdVidas == 4) {
				UITextVidas.text = "❤️❤️❤️❤️";
			}
			if (QtdVidas == 5) {
				UITextVidas.text = "❤️❤️❤️❤️❤️";
			}
		...
		if (TagTriggerEnter.Contains("ganhar1Vida"))
		{
			print("OnTriggerEnter2D():" + TagTriggerEnter);
			QtdVidas = QtdVidas + 1; // QtdVidas++;
			Destroy(objetoTriggerEnter.gameObject);
