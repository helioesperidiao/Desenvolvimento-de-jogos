...
public class PersonagemAula03 : MonoBehaviour {
	...
	void Start () {
		...
		Colisor2dPersonagem = GetComponent<Collider2D> (); // Obtpem o componente Collider2D do objeto que possui o script

		CorpoRigidoPersonagem.gravityScale = 3.0f; // Define a escala da gravidade para o Rigidbody2D 
