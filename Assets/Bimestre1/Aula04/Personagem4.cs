...
public class Personagem4 : MonoBehaviour
{
    ...
    // Servirá de Refência para o boxCollider do Personagem
    BoxCollider2D BoxColliderPersonagem;
    ...
    void Start()
    {
        ...
        //Inicializa o Colisor de box do Personagem
        BoxColliderPersonagem = GetComponent<BoxCollider2D>();
    ...
    void PularTocandoAlgo()
    {
        //verdadeiro(true) se o botão de Jump foi pressionado
        ApertouBotaoPulo = Input.GetButtonDown("Jump");

        //verdadeiro(true) se o personagem estiver tocando outro objeto com collider
        EstaTocandoAlgo = BoxColliderPersonagem.IsTouchingLayers();

        if (ApertouBotaoPulo == true)
        {
            if (EstaTocandoAlgo == true)
            {
